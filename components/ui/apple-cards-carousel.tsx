      ...
      >
        ...
        <div
          className={cn(
            ...
            "max-w-lg md:max-w-7xl mx-0" // remove max-w-4xl if you want the carousel to span the full width of its container
          )}
        >
          {items.map((item, index) => (
            <motion.div
              ...
              key={"card" + index}
              className="last:pr-[2%] md:last:pr-[2%] rounded-3xl"
            >
              {item}
            </motion.div>
          ))}
      ...
      >
        ...
        <div className="relative z-40 p-8">
          ...
          <motion.p
            ...
            className="text-white text-xl md:text-3xl font-semibold text-left [text-wrap:balance] font-sans mt-2"
          >
            {card.title}
          </motion.p>
        </div>
